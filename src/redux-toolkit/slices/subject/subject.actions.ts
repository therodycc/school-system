...
export const createSubject = (
    ...
    return async (dispatch: Function) => {
        ...
        if (!res || res?.error)
            return sweetAlert.alert("Error", "Error creando materia", "error");
...
export const updateSubject = (
    ...
    return async (dispatch: Function) => {
        ...
        if (!res || res?.error)
            return sweetAlert.alert("Error", "Error actualizando materia", "error");
        sweetAlert.alert("Success", "Done!", "success");
        successAction?.();
        dispatch(getAllSubject());
    };
...
export const removeSubject = (id: number) => {
    return async (dispatch: Function) => {
        ...
        if (!res || res?.error)
            return sweetAlert.alert("Error", "Error borrando materia", "error");
        sweetAlert.alert("Success", "Done!", "success");
        dispatch(getAllSubject());
    };
};
